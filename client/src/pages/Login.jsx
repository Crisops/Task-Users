  ...
  return (
    <div className='w-full h-full flex flex-col justify-center items-center'>
      <form onSubmit={onSubmit} className='w-96 h-96 flex flex-col justify-center gap-2 bg-zinc-950 p-4'>
        <h3 className='text-center text-xl font-serif text-zinc-50 font-bold'>Sign in</h3>
        <Input
          type='email'
          placeholder='Email'
        ...
        />
        <button className='bg-sky-500 text-white font-serif px-1 py-2 transition-colors hover:bg-sky-600' type='submit'>Next</button>
